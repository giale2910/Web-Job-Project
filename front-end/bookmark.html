                ...
                <div class="dashboard-nav d-none d-xl-block d-lg-block">
                    <div class="dashboard-inner">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="bookmark.html"><i class="flaticon-heart"></i>Bookmark</a></li>
                            <li><a href="applied.html"><i class="flaticon-safe"></i>Applied</a></li>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="job-box jb-3">
                                        ...
                                        <div class="description">
                                            <div class="float-left">
                                                <h5 class="title"><a href="job-details.html">Media and Public Relation</a></h5>
                                                <div class="candidate-listing-footer">
                                                    <ul>
                                                        <li><i class="flaticon-work"></i> Hotel</li>
                                                        <li><i class="flaticon-pin"></i> New York City</li>
