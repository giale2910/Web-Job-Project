                ...
                <ul class="navbar-nav header-ml">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dm-2" aria-labelledby="navbarDropdownMenuLink9">
                            <li><a class="dropdown-item" href="candidate-list.html">Candidate Listing</a></li>
...
<!-- Icon lists start -->
<div class="icon-lists content-area-7">
    <div class="container">
        <div class="row mb-40">
            <div class="col-lg-12">
                <h1 class="heading-2">Font Awesome</h1>
                <mark>Usage: &nbsp; &lt;i class="fa fa-fw"&gt;&lt;/i&gt;</mark>
           </div>
            <div class="col-lg-12 font-awesome-icons">
                <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="heading-2">Linearicons</h1>
